...
//@ts-ignore
const OrdersTablehf = ({ data, showTable }) => {
  ...
  const columnTabs = [
    ...
    },
    {
      ...
      key: 'ordered_from',
      ...getColumnSearchProps('ordered_from', 'ordered_from'),
    },
    {
      title: 'Quantity',
      dataIndex: 'quantity_needed',
  ...
  return (
    <Table
      //@ts-ignore
      columns={showTable ? columnTabs : columns}
