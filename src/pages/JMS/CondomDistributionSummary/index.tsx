...
import CondomDistrictDistribution from '../../../components/CondomDistrictDistribution';
...
const CondomDistributionSummary: React.FC<Props> = ({ data }) => {
  ...
  return (
    <div className='flex flex-col'>
      ...
      <div className='mt-5'>
        <CondomDistrictDistribution data={filteredData} />
      </div>

      {/* <div className="flex mt-10">
        <div className="flex-1 ml-4">
          <DistrictDistributionChart data={filteredData} />
        </div>
      </div> */}
    </div>
  );
