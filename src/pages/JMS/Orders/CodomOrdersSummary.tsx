...
import QuantityNeeded from './CondomQuantityNeeded';
...
const CondomOrdersSummary: React.FC<Props> = ({ data }) => {
  ...
  return (
    <div className='flex flex-col'>
      ...
      /> 
          ...
          <QuantityNeeded data={filteredData}/>


      <div className='mt-5'>
        <OrderStatusSummary data={filteredData} /> 
      </div>
...
export default CondomOrdersSummary;
